...
class UVShapeGenerator:
    ...
    def display_error(self, error: Exception):
        ...
        pm.confirmDialog(title='Error Creating initial shapes!',
                         message='There was an error creating the initial shapes.  This is usually due to badly formed UV unwrapping with self intersections.  Try remapping UVs or triangulating the mesh.',
                         button=['OK'],
                         defaultButton='OK')
